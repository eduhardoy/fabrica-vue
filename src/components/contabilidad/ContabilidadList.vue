<template>
  <div class="contabilida">
    <button class="add__button" @click="openAddModal">
      <img src="./images/plus.svg" alt="" />
    </button>
    <div class="contabilida__head">
      <div class="contabilida__head__title">
        <h2>CONTABILIDAD</h2>
      </div>
    </div>
    <div class="contabilida__accordion__wrapper">
      <slot></slot>
    </div>
  </div>
  <ModalAdd ref="add">
...
.contabilida__accordion__wrapper {
  height: 85%;
  width: 100%;
  display: flex;
  justify-content: center;
