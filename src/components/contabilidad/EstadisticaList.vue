<template>
  <div class="estadistic">
    ...
    <div class="estadistic__head">
      <div class="estadistic__head__title">
        <h2>ESTADISTICA</h2>
      </div>
    </div>
    <div class="estadistic__accordion__wrapper">
      <slot></slot>
    </div>
  </div>
...
.estadistic__accordion__wrapper {
  height: 85%;
  width: 100%;
  display: flex;
  justify-content: center;
